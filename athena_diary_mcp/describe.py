...
DESCRIBE_SPEC: Dict[str, Any] = {
    ...
    "plugin": {
        ...
        "description": (
            ...
            "(write/get/search/sleeptime clerk). Entries stay canonical; related notes link via "
            "see_also (cross-refs populated by sleeptime). Named after Sanctum agent Athena "
